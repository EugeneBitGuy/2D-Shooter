...
public class Health : MonoBehaviour
{
    ...
    public void BecomeInvincible(float invisibilityTime)
    {
        timeToBecomeDamagableAgain = Time.time + invisibilityTime;
    ...
    void HandleDeathWithLives()
    {
        ...
        else
        {
            ...
            if (gameObject.GetComponent(typeof(IDestroyable)))
            {
                var destroyable = (IDestroyable) gameObject.GetComponent(typeof(IDestroyable));
                destroyable.DoBeforeDestroy();
            }
