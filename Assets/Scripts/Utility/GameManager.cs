...
public class GameManager : MonoBehaviour
{
    ...
    private void HideKeyInRandomLootObject()
    {
        List<Loot> objectsWithLoot = FindObjectsOfType<Loot>().ToList();

        Loot objectWithKey = objectsWithLoot[Random.Range(0, objectsWithLoot.Count)];

        objectWithKey.MakeKeyKeeper();
    }
